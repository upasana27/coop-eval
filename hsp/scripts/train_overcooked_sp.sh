...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=${cuda_device} python ./scripts/train/train_overcooked_sp.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --layout_name ${layout} --num_agents ${num_agents} \
